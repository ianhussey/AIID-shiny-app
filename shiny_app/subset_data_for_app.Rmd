...
load("../../AIID-study/data/subsets/attitudes_2.0_subset_exploratory.RData")
...
# trim
temp_1 <- attitudes_2.0_subset_exploratory %>%
...
# self report data
reshaped_data <- attitudes_2.0_subset_exploratory %>%
  filter(!is.na(domain)) %>%
  select(domain,
         prefer,
         gut_diff,
...
# iat data
iat_data <- attitudes_2.0_subset_exploratory %>%
